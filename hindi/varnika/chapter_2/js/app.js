...
const scoreFeedback = (userScore) => {
  ...
  if (userScore >= 80 && userScore <= 100) {
    confettiStart();
    resultFeedback.textContent = `आप Hindi में माहिर हैं। शानदार प्रदर्शन के लिए बधाई! इसी तरह मेहनत करते रहें और अपनी प्रतिभा दिखाते रहें।`;
  } else if (userScore >= 60 && userScore < 80) {
    confettiStart();
    resultFeedback.textContent = `आपकी Hindi में अच्छी समझ है। अभ्यास और ध्यान से आप इस विषय में उत्कृष्टता प्राप्त कर सकते हैं। शानदार काम जारी रखें! `;
  } else if (userScore >= 40 && userScore < 60) {
    confettiStart();
    resultFeedback.textContent = `आपकी Hindi में समझ ठीक है, लेकिन सुधार की आवश्यकता है। नियमित अभ्यास और सामग्री की समीक्षा से अपनी समझ मजबूत करें। अतिरिक्त सहायता और संसाधन लें ताकि आप इसमें और बेहतर कर सकें।`;
  } else {
    confetti.clear();
    resultExpression.textContent = `सुधार की जरूरत!!!`;
    resultFeedback.textContent = `इस परीक्षा का परिणाम अच्छा नहीं है। गणित में सुधार के लिए नियमित अभ्यास और मदद लें।`;
  }
};
